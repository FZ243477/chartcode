...
export const seeMyBought = params => post('/api/index/seeMyBought',params);  //我购买的图片
export const seeMyCollection = params => post('/api/index/seeMyCollection',params);  //查看我收藏的图片
