...
<!--        <x-header class="title" :left-options="{backText: ''}">设置</x-header>-->
        <div class="list" style="background-color: rgb(255, 255, 255);">
          <div class="line"></div>
          <div class="list-item" @click="copyrightNotice" >
            <div>个人资料</div>
...
<!--            <div class="login-out" @click="logout">退出登录</div>-->
      ...
      <div id="dis_requ_show" class="requirements_shadow" style="display: none;" ref="homePage2">
        <div  class="requirements demand-wrapper-commit">
            ...
            <div class="input_text van-cell van-field">
              <div class="van-cell__value van-cell__value--alone van-field__value">
                <div class="van-field__body">
                  <input type="text" placeholder="请留下您的姓名......" class="van-field__control" />
                </div>
              </div>
            </div>
          </div>
          <div class="van-cell-group van-hairline--top-bottom">
            <div class="input_text van-cell van-field">
              <div class="van-cell__value van-cell__value--alone van-field__value">
                <div class="van-field__body">
                  <input type="text" placeholder="请留下您的电话......" class="van-field__control" />
                </div>
              </div>
            </div>
          </div>
          <div class="van-cell-group van-hairline--top-bottom">
            <div class="input_textarea van-cell van-field van-field--min-height">
              <div class="van-cell__value van-cell__value--alone van-field__value">
                <div class="van-field__body">
                  <textarea placeholder="请输入您的需求......" class="van-field__control"></textarea>
                </div>
              </div>
            </div>
          </div>
          <a href="#" class="down_img" style="margin-top: 0.3rem;">提交</a>
          <a href="tel:0571-88693669" class="down_img" style="margin-top: 0.3rem; background: rgb(244, 244, 244); color: rgb(0, 157, 250);">联系我们</a>
        </div>
      </div>
